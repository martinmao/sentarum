 ...
 */
public interface AbstractActivityEntityMapper {


    default ActivityEntity toEntity(Activity activity) {
        return null;
    }

    default Activity toModel(ActivityEntity entity) {
        if (null == entity || !Hibernate.isInitialized(entity)) {
            return null;
        }
