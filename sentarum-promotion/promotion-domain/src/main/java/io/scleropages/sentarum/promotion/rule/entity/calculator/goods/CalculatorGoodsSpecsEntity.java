...
/**
 * referenced from {@link CalculatorGoodsSpecs}
 *
 * @author <a href="mailto:martinmao@icloud.com">Martin Mao</a>
 */
@Entity
@Table(name = "prom_calc_goods_specs")
@SequenceGenerator(name = "prom_calc_goods_specs_id", sequenceName = "seq_prom_calc_goods_specs", allocationSize = IdEntity.SEQ_DEFAULT_ALLOCATION_SIZE, initialValue = IdEntity.SEQ_DEFAULT_INITIAL_VALUE)
public class CalculatorGoodsSpecsEntity extends GoodsSpecsEntity {


    @Override
    @ManyToOne(fetch = FetchType.LAZY, targetEntity = CalculatorGoodsEntity.class)
