 ...
 */
@Component
public class GoodsDiscountEvaluator implements GoodsEvaluator<GoodsDiscountRule> {


    @Override
    public void evaluate(GoodsDiscountRule rule, GoodsPromotionContext promotionContext, InvocationChain chain) {
