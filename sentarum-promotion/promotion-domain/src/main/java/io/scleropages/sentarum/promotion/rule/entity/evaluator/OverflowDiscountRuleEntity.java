...
/**
 * referenced from: {@link io.scleropages.sentarum.promotion.rule.model.evaluator.OverflowDiscountRule}
 *
 * @author <a href="mailto:martinmao@icloud.com">Martin Mao</a>
 */
@Entity
@Table(name = "prom_eval_overflow_discount")
@SequenceGenerator(name = "prom_eval_overflow_discount_id", sequenceName = "seq_prom_eval_overflow_discount", allocationSize = IdEntity.SEQ_DEFAULT_ALLOCATION_SIZE, initialValue = IdEntity.SEQ_DEFAULT_INITIAL_VALUE)
public class OverflowDiscountRuleEntity extends BaseEvaluatorRuleEntity {
