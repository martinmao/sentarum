 ...
 */
public class MarketingCategoryModel extends CategoryModel implements MarketingCategory {


    private List<StandardCategoryLink> standardCategoryLinks;

    public List<StandardCategoryLink> getStandardCategoryLinks() {
    ...
    @Override
    public List<StandardCategoryLink> standardCategoryLinks() {
        return getStandardCategoryLinks();
    }
}
