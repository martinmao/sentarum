...
public enum PropertyValueType {
    ...
    private static final Map<String, PropertyValueType> nameMappings = new HashMap<>(16);
    private static final Map<Integer, PropertyValueType> ordinalMappings = new HashMap<>(16);
