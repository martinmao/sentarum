...
/**
 * 参考模型: {@link io.scleropages.sentarum.item.category.model.impl.CategoryModel}
 *
...
public class AbstractCategoryEntity extends IdEntity {
    ...
    private AbstractCategoryEntity parent;
    ...
    @Transient
    public AbstractCategoryEntity getParent() {
        return parent;
    }
    ...
    public void setParent(AbstractCategoryEntity parent) {
        this.parent = parent;
    }
