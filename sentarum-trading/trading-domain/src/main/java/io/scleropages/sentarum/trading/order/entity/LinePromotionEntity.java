 ...
 */
@Entity
@Table(name = "td_order_line_promotion")
@SequenceGenerator(name = "td_order_line_promotion_id", sequenceName = "seq_td_order_line_promotion", allocationSize = IdEntity.SEQ_DEFAULT_ALLOCATION_SIZE, initialValue = IdEntity.SEQ_DEFAULT_INITIAL_VALUE)
